...
for Categodry B we have to bill only for 2 items. 
...
package FS;
import java.util.*;
public class Fs_Day_7_Program_2 {
	public int result(int[] a,char[] c)
    {
        Arrays.sort(c);
        int count = 1;
        int sum = 0;
        ...
        count = count - count/3;
        sum = sum + count*a[(int)(c[c.length-1]-'A')];  
        return sum;
    }
    public static void main(String[] args)
    {
    	Fs_Day_7_Program_2 m = new Fs_Day_7_Program_2();
