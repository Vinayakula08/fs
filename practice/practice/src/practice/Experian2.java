...
//
//Saved contacts are numbered from 0 to N-1. They are represented by two arrays A, B of N strings each. Name of
//K-th contact is A[K] and phone number is B[K].
//
//Write a function:
// 
...
//whose phone number contains P as a substring, that is a contiguous segment(for example, "436800143" contains as a substring 
//"6800, but not "3614").
//
...
//Examples:
//
//1. Given A = ["pim","pom"], B = ["999999999","777888999"] and P = "88999", your function should return "pom", because only
//   pom's phone number contains "88999".
//  
//2. Given A = ["sander","amy","ann","michael"], B = ["123456789","234567890","789123456","123123123"] and P = "1", your
//   function should return "ann". Note that sander, ann and michael's phone numbers contain "1" but "ann" is alphabetically
//   smaller than "michael" and "sander".
//
//3. Given A = ["adam","eva","leo"], B = ["121212121","111111111","444555666"] and P = "112", your function should return 
//   "NO CONTACT", because no phone number contains "112".
//
//Assume that:
//
...
public class Experian2 {
	public static void main(String[] args) {
		...
		String[] b = s2.split(" ");
		String s = sc.next();
		PriorityQueue<String> list = new PriorityQueue<>((x,y)->x.compareTo(y));
